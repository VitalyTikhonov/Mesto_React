    ...
    <section className="project-info root__section">
      ...
      />
        ...
        <div className="project-info__description">
          ...
          <p className="project-info__text">Здесь можно публиковать фотографии мест, которые вам интересны, и смотреть изображения, добавленные другими. Чтобы добавить карточку или изменить свои данные, авторизуйтесь и перейдите в Профиль.</p>
        </div>
    </section>
  )
});
